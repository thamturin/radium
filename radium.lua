...
welcome.Text = "Welcome to Radium Hub V1!"
...
Load.MouseButton1Down:Connect(function()
	if game.PlaceId == 286090429 then
		loadstring(game:HttpGet(("https://raw.githubusercontent.com/thamturin/GUI/main/Protected%20(1).lua"), true))()
        end
	Loader:Destroy()
end)
...
Copy.Text = "Copy Adonis Discord Server Link"
Copy.TextColor3 = Color3.fromRGB(255, 255, 255)
Copy.TextScaled = true
Copy.TextSize = 45.000
Copy.TextWrapped = true
Copy.MouseButton1Down:Connect(function()
	setclipboard("https://discord.gg/rRRYGghJkv")
end)
